...
#include <vector>                   // std::vector (VertexProtector: ImGuiIO::droppedFiles)
#include <string>                   // std::wstring (VertexProtector: ImGuiIO::droppedFiles)
...
struct ImGuiIO
{
    ...
    // VertexProtector: files dropped onto the window (WM_DROPFILES). Populated by the Win32 WndProc, read by the UI.
